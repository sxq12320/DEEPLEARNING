...
# First use "smoke". After it succeeds, change to "train" or "all".
...
SERVER_OUTPUT_ROOT = Path("/data/citrus/runs/yolo")
...
YOLO_BASELINES = {"yolov8n_seg", "yolo11n_seg", "yolo26n_seg", "yolo11s_seg"}
