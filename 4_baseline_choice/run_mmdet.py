...
# First use "smoke". After the 2-epoch check succeeds, change it to "train" or "all".
# Other choices: "prepare", "test".
RUN_MODE = "smoke"
...
# Linux server paths: change these lines after copying to the server.
SERVER_SOURCE_DATASET = Path("/data/citrus/orange_yolo")
SERVER_PREPARED_DATASET = Path("/data/citrus/citrus_prepared")
SERVER_MMDET_ROOT = Path("/workspace/third_party/mmdetection")
SERVER_OUTPUT_ROOT = Path("/data/citrus/runs/mmdet")
