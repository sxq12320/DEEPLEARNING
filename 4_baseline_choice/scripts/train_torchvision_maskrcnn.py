...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-root", type=Path, default=Path("runs/torchvision_maskrcnn"))
    ...
    parser.add_argument("--imgsz", type=int, default=640, help="Maximum image side after aspect-ratio resize.")
    parser.add_argument("--val-interval", type=int, default=5, help="Validate every N epochs.")
    parser.add_argument("--save-interval", type=int, default=25, help="Keep an extra checkpoint every N epochs.")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--device", default="auto", help="auto, cpu, cuda, or cuda:0.")
    parser.add_argument("--initialization", choices=("coco", "imagenet", "none"), default="coco")
    parser.add_argument("--no-amp", action="store_true", help="Disable CUDA mixed precision.")
    parser.add_argument("--log-interval", type=int, default=20)
    parser.add_argument("--resume", type=Path, default=None, help="Resume from a saved training checkpoint.")
    return parser
...
def main() -> None:
    ...
    dataset_report = validate_prepared_dataset(dataset_root, ("train", "val"), class_names)
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        if should_validate:
            ...
            save_json(run_dir / "validation" / f"epoch_{epoch:03d}_metrics.json", val_metrics)
            ...
            if current_mask_ap > best_mask_ap:
                ...
                save_predictions(run_dir / "validation" / "best_predictions.coco.json", predictions)
