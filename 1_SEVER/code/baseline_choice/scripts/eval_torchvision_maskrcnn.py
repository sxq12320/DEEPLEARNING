...
def main() -> None:
    ...
    detections_per_image = args.detections_per_image or int(
        checkpoint_config.get("detections_per_image", 50)
    )
    ...
    metrics.update(
        {
            ...
            "imgsz": imgsz,
            "detections_per_image": detections_per_image,
            "params_m": sum(parameter.numel() for parameter in model.parameters())
            / 1e6,
