"""Edit DATA/DEVICE, then click VS Code Run. Sequential foreground E V3 training."""
...
SUITE = "all"  # all=8 arms; priority=E30-E33; combined=E34-E37
EPOCHS = 300
PROJECT = f"/data/sxq/results/E_V3/CITRUS_EV3_{SUITE.upper()}_{EPOCHS}EP"
DRY_RUN = False
SEEDS = "42"
ONLY = ""
PRETRAINED = ""
