"""Edit DATA/DEVICE, then click VS Code Run. Sequential foreground E V7 training."""
...
SUITE = "all"  # all=8 arms; priority=V7_00--04; combined=V7_05--07
EPOCHS = 300
PROJECT = f"/data/sxq/results/E_V7/CITRUS_EV7R2_{SUITE.upper()}_{EPOCHS}EP"
DRY_RUN = False
SEEDS = "42"
ONLY = ""
PRETRAINED = ""
