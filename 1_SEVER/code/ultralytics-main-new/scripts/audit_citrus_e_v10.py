"""Build/profile ten E V10 arms, optionally exercise a tiny real sliced-data training loop."""
...
from citrus_e_v10_suite import NAMES, RUN_OVERRIDES, YAML_DIR
...
def main():
    ...
    if args.smoke_data:
        ...
        for name in (NAMES[0], NAMES[8], NAMES[9]):
