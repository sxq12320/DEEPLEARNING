"""Same-device synthetic timing for SAGE-v6; not dataset accuracy or end-to-end FPS."""

# ruff: noqa: E402 -- allow direct script execution from outside the project root
...
from citrus_sage_v6_suite import NAMES, YAML_DIR
