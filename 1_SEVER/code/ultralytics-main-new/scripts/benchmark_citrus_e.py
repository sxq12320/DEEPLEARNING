"""Interleaved E compute benchmark. Synthetic timings are not dataset accuracy or deployment FPS."""
...
from citrus_e_suite import SUITES, YAML_DIR
...
def main():
    ...
    if set(names) - set(SUITES["all"]) or len(names) != len(set(names)) or not names:
        raise ValueError("Choose distinct E models")
