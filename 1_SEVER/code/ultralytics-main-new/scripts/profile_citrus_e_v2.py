"""Bounded E V2 microbenchmark; excludes decoding/NMS, data loading and optimizer time."""
...
def main():
    ...
    batch = example_batch()
    batch["img"] = torch.rand(1, 3, 640, 640)
    ...
    report = dict(
        records=records,
        module_sha256=hashlib.sha256((ROOT / "ultralytics/nn/modules/citrus_e_v2.py").read_bytes()).hexdigest(),
        protocol=dict(
            batch=1,
            imgsz=640,
            threads=2,
