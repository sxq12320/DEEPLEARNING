"""Edit DATA/DEVICE, then click VS Code Run. Sequential foreground E V8 training."""
...
SUITE = "all"  # all=10 arms; priority=00/03/04/05/08; combined=06--09
EPOCHS = 300
PROJECT = f"/data/sxq/results/E_V8/CITRUS_EV8_{SUITE.upper()}_{EPOCHS}EP"
DRY_RUN = False
SEEDS = "42"
ONLY = ""
PRETRAINED = ""
