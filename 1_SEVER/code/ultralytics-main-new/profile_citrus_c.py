"""Export parameter, FLOP, and direct pretrained-transfer profiles for CitrusC."""
...
OUTPUT = ROOT / "1_results" / "_compatibility" / "citrus_c_profiles.csv"


def main() -> None:
    """Profile every C YAML at nc=1 and a 640-square input."""
