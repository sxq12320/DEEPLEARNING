"""Queue safety, mask checkpoint selection and initialization provenance for v6."""
...
from citrus_sage_v6_suite import NAMES, ROOT, YAML_DIR
from ultralytics import YOLO


@pytest.fixture
def batch_module():
    spec = importlib.util.spec_from_file_location("sage_v6_test_runner", ROOT / "20260905_citrus_sage_v6_batch.py")
...
def test_real_trainer_calls_batch_callbacks_on_explicit_smoke_fixture(batch_module, tmp_path, monkeypatch):
    ...
    name = NAMES[-1]  # Exercise the two geometry losses as well as standard callbacks.
    monkeypatch.setattr(
        sys,
        "argv",
        [
