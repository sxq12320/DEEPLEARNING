...
@pytest.fixture
def batch_module():
    spec = importlib.util.spec_from_file_location("sage_v8_test_runner", ROOT / "20260907_citrus_sage_v8_batch.py")
...
def test_real_trainer_calls_batch_callbacks_on_explicit_smoke_fixture(batch_module, tmp_path, monkeypatch):
    ...
    name = NAMES[-1]  # Exercise the phase-detail arm and standard callbacks.
    monkeypatch.setattr(
        sys,
        "argv",
        [
