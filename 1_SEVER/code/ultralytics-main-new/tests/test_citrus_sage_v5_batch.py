"""Queue safety, mask checkpoint selection and initialization provenance for v5."""
...
from citrus_sage_v5_suite import NAMES, ROOT, YAML_DIR
from ultralytics import YOLO


@pytest.fixture
def batch_module():
    spec = importlib.util.spec_from_file_location("sage_v5_test_runner", ROOT / "20260904_citrus_sage_v5_batch.py")
