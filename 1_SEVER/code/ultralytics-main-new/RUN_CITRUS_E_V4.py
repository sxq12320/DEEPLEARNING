"""Edit DATA/DEVICE, then click VS Code Run. Sequential foreground E V4R training."""
...
SUITE = "all"  # all=8 arms; priority=V4R00--03; combined=V4R04--07
EPOCHS = 300
PROJECT = f"/data/sxq/results/E_V4R/CITRUS_EV4R_{SUITE.upper()}_{EPOCHS}EP"
DRY_RUN = False
SEEDS = "42"
ONLY = ""
PRETRAINED = ""
