"""Edit DATA/DEVICE, then click VS Code Run. Sequential foreground E V9 training."""
...
SUITE = "all"  # all=10 arms; priority=01/02/03/04/08; losses=01/05/07/08/09
EPOCHS = 300
PROJECT = f"/data/sxq/results/E_V9/CITRUS_EV9_{SUITE.upper()}_{EPOCHS}EP"
DRY_RUN = False
SEEDS = "42"
ONLY = ""
PRETRAINED = ""
