"""Edit DATA/DEVICE, then click VS Code Run. Sequential foreground E V6 training."""
...
SUITE = "all"  # all=10 arms; priority=00/01/02/03/08; see docs/E_V6_REVIEW_20260912
EPOCHS = 300
PROJECT = f"/data/sxq/results/E_V6/CITRUS_EV6R_{SUITE.upper()}_{EPOCHS}EP"
DRY_RUN = False
SEEDS = "42"
ONLY = ""
PRETRAINED = ""
