...
SEED = 42
DATA = r"E:/mastercode/data/orange_yolo_grouped_dedup_20260820/data.yaml"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--data", default=DATA, help="Dataset YAML. Defaults to the leakage-free grouped-dedup split.")
