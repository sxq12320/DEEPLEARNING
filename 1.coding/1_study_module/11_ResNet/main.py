...
from ResNet import ResNetBlock_34 , ResNetBlock_50 , ResNet_18 , ResNet_34 , ResNet_50 , ResNet_101 , ResNet_152 , ResNet_CIFAR10_34
...
def train_model():
    ...
    # 初始化模型
    model = ResNet_CIFAR10_34().to(device)
