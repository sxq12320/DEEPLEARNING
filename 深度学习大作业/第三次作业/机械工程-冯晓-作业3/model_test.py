...
def test_data_process():
    ...
    normalize = transforms.Normalize([0.22890999, 0.1963964, 0.14335695], [0.09950783, 0.07997292, 0.06596899])
    # 定义数据集处理方法变量
...
#输入与一张待检测的图片，利用我们的模型给他进行分类
    image = Image.open('12398452_113933740124_2.jpg')
