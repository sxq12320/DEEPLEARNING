...
if __name__ == '__main__':
	file_path = r"E:\mastercode\data\KOUZHAO\images"  # 图片文件夹
	label_path = r'E:\mastercode\data\KOUZHAO\TXT'  # 标签文件夹
	new_file_path = r"E:\mastercode\data\KOUZHAO\FINAL"  # 新数据存放位置
