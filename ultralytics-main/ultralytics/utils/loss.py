...
class v8SegmentationLoss(v8DetectionLoss):
    ...
    xyxy: torch.Tensor,
        ...
        with torch.cuda.amp.autocast(enabled=False):
            ...
            # --- 下方保留你的 Dice Loss 部分 ---
            # 因为我们不再显式求取 a,b,t，我们可以直接计算原图域上的 Dice
